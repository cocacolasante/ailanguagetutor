  ...
  <table width="100%%" cellpadding="0" cellspacing="0" style="background:#0f0f13;padding:40px 20px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1a1a24;border-radius:16px;overflow:hidden;max-width:560px;width:100%%;">
        ...
        <tr>
          <td style="padding:40px;">
            <h2 style="margin:0 0 16px;color:#f0f0f8;font-size:1.25rem;font-weight:600;">You're invited to try LinguaAI! 🎉</h2>
            <p style="margin:0 0 12px;color:#a0a0b8;line-height:1.6;">Hi %s,</p>
            <p style="margin:0 0 20px;color:#a0a0b8;line-height:1.6;">
              You've been given <strong style="color:#f0f0f8;">30 days of free beta access</strong> to LinguaAI — an AI-powered language tutor for Italian, Spanish, and Portuguese. No credit card required.
            </p>
	...
	fmt.Fprintf(&msg, "From: LinguaAI <%s>\r\n", cfg.EmailFrom)
	fmt.Fprintf(&msg, "To: %s\r\n", toEmail)
	fmt.Fprintf(&msg, "Subject: You're invited — 30-day free trial of LinguaAI\r\n")
	fmt.Fprintf(&msg, "MIME-Version: 1.0\r\n")
	fmt.Fprintf(&msg, "Content-Type: text/html; charset=UTF-8\r\n")
	fmt.Fprintf(&msg, "\r\n")
	msg.WriteString(htmlBody)
...
<body style="margin:0;padding:0;background:#0f0f13;font-family:'Segoe UI',Arial,sans-serif;">
  <table width="100%%" cellpadding="0" cellspacing="0" style="background:#0f0f13;padding:40px 20px;">
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#1a1a24;border-radius:16px;overflow:hidden;max-width:560px;width:100%%;">
        ...
        <tr>
          <td style="padding:40px;">
            ...
            <p style="margin:0 0 12px;color:#a0a0b8;line-height:1.6;">Hi %s,</p>
            <p style="margin:0 0 28px;color:#a0a0b8;line-height:1.6;">
              We received a request to reset your LinguaAI password. Click the button below to choose a new password. This link expires in 1 hour.
            </p>
            <table cellpadding="0" cellspacing="0" style="margin:0 auto 28px;">
              <tr>
                <td align="center" style="background:linear-gradient(135deg,#7c3aed,#2563eb);border-radius:10px;">
	...
	fmt.Fprintf(&msg, "From: LinguaAI <%s>\r\n", cfg.EmailFrom)
	fmt.Fprintf(&msg, "To: %s\r\n", toEmail)
	fmt.Fprintf(&msg, "Subject: Reset your LinguaAI password\r\n")
	fmt.Fprintf(&msg, "MIME-Version: 1.0\r\n")
	fmt.Fprintf(&msg, "Content-Type: text/html; charset=UTF-8\r\n")
	fmt.Fprintf(&msg, "\r\n")
	msg.WriteString(htmlBody)
